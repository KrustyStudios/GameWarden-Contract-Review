...
- Interrupted recovery and blind-peer cancellation terminate only a live adapter whose PID and UTC start time exactly match its retained invocation receipt. A mismatch fails closed as possible PID reuse.
